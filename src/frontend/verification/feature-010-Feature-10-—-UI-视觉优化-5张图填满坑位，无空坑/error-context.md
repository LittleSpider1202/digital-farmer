...
- Name: feature-010.spec.ts >> Feature #10 — UI 视觉优化 >> 5张图填满坑位，无空坑
- Location: tests/feature-010.spec.ts:81:7
    ...
    - generic [ref=e3]:
      ...
      - generic [ref=e7]:
        - generic [ref=e8]:
          ...
          - generic [ref=e18]:
            - img "预览 4" [ref=e19]
            - button "移除第4张图片" [ref=e20] [cursor=pointer]: ✕
          - generic [ref=e21]:
            - img "预览 5" [ref=e22]
            - button "移除第5张图片" [ref=e23] [cursor=pointer]: ✕
        - generic [ref=e24]:
          - button "添加图片" [disabled] [ref=e25]:
            - img [ref=e26]
          - textbox "描述症状（可选）…" [ref=e28]
          - button "开始诊断" [ref=e29] [cursor=pointer]:
            - img [ref=e30]
        - paragraph [ref=e33]: 5/5 张 · JPG/PNG/WebP · 单张≤10MB
