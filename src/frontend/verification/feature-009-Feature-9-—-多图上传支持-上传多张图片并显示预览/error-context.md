...
- Name: feature-009.spec.ts >> Feature #9 — 多图上传支持 >> 上传多张图片并显示预览
- Location: tests/feature-009.spec.ts:18:7
...
Locator:  locator('[data-testid="image-previews"]').locator('div.border-dashed')
Expected: 2
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="image-previews"]').locator('div.border-dashed')
    ...
    - generic [ref=e3]:
      ...
      - generic [ref=e7]:
        - generic [ref=e8]:
          ...
          - generic [ref=e15]:
            - img "预览 3" [ref=e16]
            - button "移除第3张图片" [ref=e17] [cursor=pointer]: ✕
        - generic [ref=e18]:
          - button "添加图片" [ref=e19] [cursor=pointer]:
            - img [ref=e20]
          - textbox "描述症状（可选）…" [ref=e22]
          - button "开始诊断" [ref=e23] [cursor=pointer]:
            - img [ref=e24]
        - paragraph [ref=e27]: 3/5 张 · JPG/PNG/WebP · 单张≤10MB
